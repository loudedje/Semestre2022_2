    ...
    while (opcao1 != EXIT)
    {
        ...
        switch(opcao1)
        {
                ...
                while(opcao2 != EXIT)
                {
                    ...
                    { 
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            printf("Função não implementada: update\n");
                            break;
                        case 4:
                            printf("Função não implementada: list\n");
                            break;
                        case 5:
                            printf("Função não implementada: delete\n");
                            break;
                    }
                }
                break;
            ...
            case 3: // Visualizar itens duplicados
                printf("Função não implementada: intersect\n");
                break;
        }
    }
